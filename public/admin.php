...
<head>
    ...
    <title>Администрирование поддержки</title>
    <script>
        (function() {
            try {
    ...
    <link rel="stylesheet" href="assets/admin-panel.css?v=20260708-admin-page">
</head>
<body>
    <main class="admin-shell">
        <header class="admin-topbar">
            ...
            <nav class="admin-nav" aria-label="Навигация">
                <a href="./">Диалоги</a>
                <a class="active" href="admin.php">Администрирование</a>
            </nav>
        ...
        <section class="admin-grid">
            <article class="admin-card users-card">
                <div class="card-head">
                    <div>
                        ...
                        <p>Поиск по имени, Telegram, email или ID</p>
                    </div>
                ...
                <button class="secondary-btn" id="loadMoreUsers" type="button">Показать ещё</button>
            </article>
            ...
            <article class="admin-card">
                <div class="card-head">
                    <div>
                        <h2>Менеджеры</h2>
                        <p>Добавление, смена пароля и блокировка</p>
                    </div>
                </div>
            ...
            <article class="admin-card logs-card">
                <div class="card-head">
                    <div>
                        <h2>Telegram-лог</h2>
                        <p>Последние входящие и исходящие действия</p>
                    </div>
    ...
    <script src="assets/admin-panel.js?v=20260708-admin-page"></script>
</body>
</html>
